...
async function apiLoadTxns() {
  try { const data = await apiFetch("/transactions?limit=5000"); return data?.transactions || []; }
  catch (_) { return []; }
}
...
async function apiAnalyze() {
  try { return await apiFetch("/coaching/analyze", { method: "POST" }); }
  catch (_) { return null; }
}

// Wake up HuggingFace Space on load (prevents cold-start delays)
...
const OCCUPATION_GROUPS = [
  {
    ...
    jobs: [
      ...
      "Casual labourer / Mfanyakazi wa muda", "Delivery rider / Mpiga mbio wa delivery",
  ...
  },
  {
    ...
    jobs: [
      "Casual artisan / Fundi wa nasibu", "Tailor (casual) / Fundi kushona (nasibu)",
  ...
  },
  {
    ...
    jobs: [
      "Boda boda rider / Dereva wa boda boda", "Motorcycle taxi / Teksi ya pikipiki",
...
const COACHING_DB = {
  "Daily Hustler_1": {
    en: "CRISIS: Stop all non-essential spending today. Send KES 50 to M-Shwari right now — even this small amount builds the habit. Avoid Fuliza completely for 7 days.",
    sw: "DHARURA: Simamisha matumizi yote yasiyohitajika leo. Tuma KES 50 M-Shwari sasa hivi. Epuka Fuliza kabisa kwa siku 7."
  },
  "Daily Hustler_2": {
    en: "You earn every day but spend everything same day. Each morning before any spending, lock KES 100 in M-Shwari. After 30 days you will have KES 3,000 saved.",
    sw: "Unapata pesa kila siku lakini unatumia yote. Kila asubuhi kabla ya kutumia, funga KES 100 M-Shwari. Siku 30 utakuwa na KES 3,000."
  },
  "Daily Hustler_3": {
    en: "Good earning rhythm. Build resilience: save KES 200/day in M-Shwari. In 3 months you will have KES 18,000 — enough to survive one slow month without Fuliza.",
    sw: "Una mdundo mzuri wa mapato. Jenga nguvu: weka KES 200/siku M-Shwari. Miezi 3 utakuwa na KES 18,000."
  },
  "Daily Hustler_4": {
    en: "Strong financial discipline. Join a chama or SACCO to grow savings faster. Consider Hustler Fund — repaying on time builds your credit limit from KES 500 to KES 50,000.",
    sw: "Nidhamu nzuri ya fedha. Jiunge na chama au SACCO kukua akiba haraka. Fikiria Hustler Fund."
  },
  "Small-Scale Trader_1": {
    en: "Business is losing money. Stop restocking until you understand why. Count your stock today and compare to last week — find what is not selling and stop buying it.",
    sw: "Biashara inapoteza pesa. Simamisha kujaza bidhaa mpaka uelewa sababu. Hesabu bidhaa zako leo."
  },
  "Small-Scale Trader_2": {
    en: "Restock in smaller amounts daily rather than large amounts weekly. Use Pochi La Biashara to separate business from personal money.",
    sw: "Jaza bidhaa kidogo kila siku badala ya kiasi kikubwa wiki moja. Tumia Pochi La Biashara."
  },
  "Small-Scale Trader_3": {
    en: "Business is surviving. Find your 3 best-selling items and always keep them stocked. Save 10% of profit in M-Shwari each week before spending on anything else.",
    sw: "Biashara inasimama. Tafuta bidhaa 3 zinazouza zaidi na uzidumishe. Weka 10% ya faida M-Shwari."
  },
  "Small-Scale Trader_4": {
    en: "Business is growing. Join a traders SACCO, apply for a Stawi loan (rates from 9%), and consider expanding to a second product line.",
    sw: "Biashara inakua. Jiunge SACCO ya wafanyabiashara, omba mkopo wa Stawi (riba kuanzia 9%)."
  },
  "Artisan - Stable_1": {
    en: "Work has dried up. Contact 5 past clients today for follow-up jobs. Offer a small discount for bookings this week. One job now is better than waiting.",
    sw: "Kazi imeisha. Wasiliana na wateja 5 wa zamani leo. Toa punguzo dogo kwa miadi wiki hii."
  },
  "Artisan - Stable_2": {
    en: "Consistent work but income is tight. Quote 10% higher on your next 3 projects — most clients will not notice. Save that extra directly into M-Shwari.",
    sw: "Kazi ya kawaida lakini mapato ni kidogo. Toa bei 10% zaidi kwa miradi 3 ijayo."
  },
  "Artisan - Stable_3": {
    en: "Good steady work. Build a KES 15,000 emergency fund in M-Shwari. Register for SHA health cover (KES 500/month) so one illness does not wipe your savings.",
    sw: "Kazi nzuri. Jenga akiba ya KES 15,000 M-Shwari. Jisajili SHA (KES 500/mwezi)."
  },
  "Artisan - Stable_4": {
    en: "Excellent discipline. Join a Jua Kali SACCO to access larger loans at better rates. Consider training an apprentice — this creates a second income stream.",
    sw: "Nidhamu bora. Jiunge SACCO ya Jua Kali. Fikiria kufunza mwanafunzi."
  },
  "Artisan - Struggling_1": {
    en: "Critical: you are spending more than you earn. Deposit all cash job payments into M-PESA immediately — even KES 50. This creates a visible savings record.",
    sw: "Muhimu: unatumia zaidi ya unavyopata. Weka malipo yote ya kazi taslimu M-PESA mara moja."
  },
  "Artisan - Struggling_2": {
    en: "Cash jobs are real income — deposit them into M-PESA to build a savings record. Specialise in one skill and charge KES 200 more per job.",
    sw: "Kazi za pesa taslimu ni mapato halisi. Bobea katika ujuzi mmoja na kutoza KES 200 zaidi."
  },
  "Artisan - Struggling_3": {
    en: "Regular work but not getting ahead. Pick your single strongest skill and market it specifically — a welder who specialises in gates earns 40% more.",
    sw: "Kazi ya kawaida lakini hupati maendeleo. Chagua ujuzi wako mmoja bora na uuuze maalum."
  },
  "Artisan - Struggling_4": {
    en: "Income improving. Save KES 500/week in M-Shwari and never touch it. In 6 months you will have KES 13,000 — enough to buy your own tools.",
    sw: "Mapato yanaboreka. Weka KES 500/wiki M-Shwari na usiguse. Miezi 6 = KES 13,000."
  },
  "Boda Boda Operator_1": {
    en: "Serious risk: one breakdown could stop your income completely. Save KES 200 every single day in M-Shwari. In 30 days you have KES 6,000 repair fund.",
    sw: "Hatari kubwa: uharibike mmoja unaweza kusimamisha mapato yako. Weka KES 200 kila siku M-Shwari."
  },
  "Boda Boda Operator_2": {
    en: "Inconsistent earnings are the problem. Track your best 3 routes or customers — focus your day on those. Save KES 300/day before fuel expenses.",
    sw: "Mapato yasiyofaa ni tatizo. Fuatilia njia zako 3 bora. Weka KES 300/siku kabla ya mafuta."
  },
  "Boda Boda Operator_3": {
    en: "Solid earnings. Build a KES 8,000 M-Shwari emergency fund so one breakdown does not wipe you out. Consider NTSA insurance (KES 5,550/year).",
    sw: "Mapato mazuri. Jenga akiba ya KES 8,000 M-Shwari. Fikiria bima ya NTSA (KES 5,550/mwaka)."
  },
  "Boda Boda Operator_4": {
    en: "Excellent income management. Think about owning a second bike through a boda boda SACCO — this doubles your income potential.",
    sw: "Usimamizi bora wa mapato. Fikiria kumiliki pikipiki ya pili kupitia SACCO ya boda boda."
  },
  "Agricultural Worker_1": {
    en: "Offseason crisis. Look for casual labour or start a small kitchen garden. Contact your nearest SACCO for a seasonal loan to prepare for the next planting.",
    sw: "Dharura ya msimu wa ukame. Tafuta kazi za muda au anza bustani ndogo. Wasiliana na SACCO kwa mkopo wa msimu."
  },
  "Agricultural Worker_2": {
    en: "Lean season stress. During harvest, save at least 20% before spending. KES 5,000 saved at harvest covers 2 lean months.",
    sw: "Msongo wa msimu wa ukame. Wakati wa mavuno, weka angalau 20% kabla ya kutumia."
  },
  "Agricultural Worker_3": {
    en: "Good seasonal management. Save 20% of every harvest payment before any spending. Register for SHA health cover — one hospital visit during planting season can destroy the whole season.",
    sw: "Usimamizi mzuri wa msimu. Weka 20% ya kila malipo ya mavuno. Jisajili SHA."
  },
  "Agricultural Worker_4": {
    en: "Strong farm management. Explore contract farming with Twiga Foods or Agri-Wallet — guaranteed buyers reduce your income risk significantly.",
    sw: "Usimamizi mzuri wa shamba. Chunguza kilimo cha mkataba na Twiga Foods au Agri-Wallet."
  },
  "Struggling Entrepreneur_1": {
    en: "Business crisis. Separate business and personal money immediately using Pochi La Biashara — free on M-PESA. Stop all credit sales this week. Cash only until stable.",
    sw: "Dharura ya biashara. Tenganisha pesa za biashara na za kibinafsi mara moja ukitumia Pochi La Biashara."
  },
  "Struggling Entrepreneur_2": {
    en: "Cash flow is the problem, not revenue. Use Pochi La Biashara. Invoice clients immediately. Pay yourself a fixed salary, not whatever is left.",
    sw: "Mtiririko wa pesa ndio tatizo. Tumia Pochi La Biashara. Jilipe mshahara maalum."
  },
  "Struggling Entrepreneur_3": {
    en: "Business is stabilising. Build a 30-day cash reserve equal to one month of fixed costs. Track your 3 highest-margin products and focus on those.",
    sw: "Biashara inaimarika. Jenga akiba ya pesa ya siku 30. Fuatilia bidhaa 3 zenye faida kubwa zaidi."
  },
  "Struggling Entrepreneur_4": {
    en: "Business is growing well. Consider a Stawi business loan (from KES 30,000 at 9% p.a.) for expansion. Register for VAT if turnover exceeds KES 5M/year.",
    sw: "Biashara inakua vizuri. Fikiria mkopo wa Stawi (kutoka KES 30,000 kwa 9% kwa mwaka)."
  },
};
...
// ═══════════════════════════════════════════════════════════════════════════
// LOCAL ANALYTICS ENGINE (client-side fallback)
// ═══════════════════════════════════════════════════════════════════════════
function computeFeatures(transactions) {
  ...
  const txns = primaryTxns.map(t => ({ ...t, amount: parseFloat(t.amount) }));
  ...
  const endBalances = days.map(d => { const dt = byDate[d]; return dt[dt.length - 1].balance || 0; });
...
const BUDGET_FRAMEWORK = {
  CRISIS: {
    needs: 90, savings: 5, debt: 5, wants: 0,
    color: "#E53E3E",
    ...
    debt_action: "Contact Tala/Branch to restructure. Do not take new loans.",
  ...
  STRESSED: {
    needs: 70, savings: 10, debt: 15, wants: 5,
    color: "#D69E2E",
    ...
    debt_actionSw: "Lipa deni lenye riba nyingi zaidi kwanza.",
    needs_action: "Track your top 3 expenses this week — find what can be reduced.",
    needs_actionSw: "Fuatilia gharama zako 3 kubwa wiki hii.",
  },
  COPING: {
    needs: 60, savings: 20, debt: 10, wants: 10,
    color: "#DD6B20",
    ...
    debt_action: "Reduce Fuliza to below 2 draws/day. Each draw costs you 5% interest.",
    debt_actionSw: "Punguza Fuliza chini ya mara 2/siku.",
  ...
  STABLE: {
    needs: 50, savings: 25, debt: 5, wants: 20,
    color: "#38A169",
    ...
    savings_actionSw: "Tofautisha: M-Shwari kwa dharura + Chama/SACCO kwa ukuaji.",
    debt_action: "No active debt? Use that 5% to invest — Hustler Fund builds credit to KES 50,000.",
    debt_actionSw: "Huna deni? Tumia asilimia 5 hiyo kuwekeza.",
    needs_action: "Needs under 50%? Excellent. Now invest surplus in income-generating skills.",
    needs_actionSw: "Mahitaji chini ya 50%? Vizuri. Sasa wekeza ziada katika ujuzi unaozalisha mapato.",
  },
};
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={S.card}>
          <div style={{ marginBottom: 16 }}>
            ...
            <input style={S.input} placeholder="07XX XXX XXX" value={phone}
          ...
          {step === 1 && (
            <div>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                {form.job_title ? (
                  ...
                  <div>
                    ...
                    <div style={{ color: "#00C875", fontSize: 13, fontWeight: 600, marginBottom: 10 }}>
                      {OCCUPATION_GROUPS[selectedGroup].label}
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                      {OCCUPATION_GROUPS[selectedGroup].jobs.map((job, j) => (
                        <button key={j} onClick={() => { update("job_title", job); update("persona", OCCUPATION_GROUPS[selectedGroup].persona); setSelectedGroup(null); }}
                      ...
                      <input style={{ ...S.input, fontSize: 13, marginTop: 4 }}
                        placeholder="My job is not listed / Kazi yangu haipo hapa..."
                        onKeyDown={e => {
                          if (e.key === "Enter" && e.target.value.trim()) {
                            update("job_title", e.target.value.trim());
                            update("persona", OCCUPATION_GROUPS[selectedGroup].persona);
                            setSelectedGroup(null);
                          }
                        }} />
                      <div style={{ color: "#4A6A8A", fontSize: 11, marginTop: 2 }}>Press Enter to use your own description</div>
                    </div>
                  </div>
                )}
              </div>
              ...
              <button style={S.btnGreen} onClick={() => {
                if (!form.name || !form.phone || !form.persona || form.password.length < 6) { setError("Fill all fields. Password min 6 characters."); return; }
                setError(""); setStep(2);
              }}>Continue →</button>
            </div>
          )}
              ...
              <div style={{ marginBottom: 24, display: "flex", gap: 16 }}>
                {[["SHA Health Cover","has_sha"],["NSSF Member","has_nssf"]].map(([label, key]) => (
                  <button key={key} onClick={() => update(key, !form[key])}
                    style={{ flex: 1, padding: "12px", borderRadius: 10, border: `2px solid ${form[key] ? "#00C875" : "#1E3A5F"}`, background: form[key] ? "#003D20" : "#0A1628", color: "#F0F4F8", cursor: "pointer", fontSize: 13 }}>
                    {form[key] ? "✓ " : ""}{label}
                  </button>
                ))}
              </div>
            ...
            <div>
              ...
              <div style={{ marginBottom: 16 }}>
                <button onClick={() => update("sends_remittance", !form.sends_remittance)}
                  style={{ width: "100%", padding: "12px", borderRadius: 10, border: `2px solid ${form.sends_remittance ? "#00C875" : "#1E3A5F"}`, background: form.sends_remittance ? "#003D20" : "#0A1628", color: "#F0F4F8", cursor: "pointer", textAlign: "left", fontSize: 14 }}>
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        <input id={id} style={{ ...S.input, paddingLeft: 48, borderColor: value && value !== "0" ? color : "#1E3A5F" }}
...
function AddTransactionModal({ onSave, onClose }) {
  ...
  const handleSave = () => {
    ...
    const sv = parseFloat(saved) || 0, b = parseFloat(borrowed) || 0;
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "flex-end", zIndex: 1000 }}
      ...
      <div style={{ width: "100%", maxWidth: 480, margin: "0 auto", background: "#0F1F35", borderRadius: "20px 20px 0 0", padding: "24px 24px 32px", maxHeight: "90vh", overflowY: "auto" }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input id="daily-date" style={S.input} type="date" value={date} onChange={e => setDate(e.target.value)} />
        </div>
        ...
        <p style={{ color: "#4A6A8A", fontSize: 11, textAlign: "center", marginTop: 12, lineHeight: 1.5 }}>
          For full transaction history, use Import PDF above · Kwa historia kamili, tumia Ingiza PDF
        </p>
      </div>
    </div>
  );
...
function BalanceSparkline({ transactions }) {
  ...
  transactions.forEach(t => {
    const d = (t.date || "").slice(0, 10);
    if (!d || d.length < 10) return;
    if (!byDate[d] || t.balance > 0) byDate[d] = t.balance;
  });
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A1628", padding: "0 0 80px" }}>
      ...
      <div style={{ padding: "20px 16px", maxWidth: 540, margin: "0 auto" }}>
        ...
        {hasRecent && (
          <div style={{ ...S.card, marginBottom: 16, borderLeft: "4px solid #534AB7" }}>
            ...
            <div style={{ fontSize: 12, color: "#4A6A8A", marginTop: 10 }}>
              {lang === "en" ? `${features.recent_days} day${features.recent_days > 1 ? "s" : ""} logged this week. Keep going!` : `Siku ${features.recent_days} zimerekodiwa wiki hii. Endelea!`}
            </div>
          </div>
        )}
        ...
        {!features && (
          <div style={{ ...S.card, marginBottom: 16, textAlign: "center", padding: "28px 20px" }}>
            ...
            <div style={{ fontWeight: 600, color: "#F0F4F8", marginBottom: 8 }}>
            ...
            <div style={{ color: "#7A9CC0", fontSize: 13, lineHeight: 1.6, marginBottom: 16 }}>
              {lang === "en"
                ? "Add today's income and spending using the + button, or import your M-PESA statement PDF."
      ...
      <div style={{ position: "fixed", bottom: 24, right: 20, display: "flex", gap: 10, alignItems: "center" }}>
        <button onClick={onBudget} style={{ padding: "11px 14px", borderRadius: 28, background: "#003D20", border: "1px solid #00C87544", color: "#00C875", fontSize: 13, cursor: "pointer", fontWeight: 600 }}>
          📊 Budget
        </button>
        <button onClick={onUpload} style={{ padding: "11px 14px", borderRadius: 28, background: "#0F1F35", border: "1px solid #1E3A5F", color: "#7A9CC0", fontSize: 13, cursor: "pointer" }}>
          📄 PDF
        </button>
        <button onClick={onAddTxn} style={{ width: 52, height: 52, borderRadius: "50%", background: "linear-gradient(135deg,#00C875,#00A35C)", border: "none", color: "#fff", fontSize: 26, cursor: "pointer", boxShadow: "0 4px 20px rgba(0,200,117,0.4)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          +
        </button>
      </div>
    </div>
        ...
        {income === 0 ? (
          ...
          <>
            ...
            <div style={{ ...S.card, background: "#0A1628" }}>
              <div style={{ fontSize: 12, color: "#00C875", fontWeight: 600, marginBottom: 12 }}>
                KENYA MONEY TOOLS · ZANA ZA FEDHA ZA KENYA
              </div>
              {[
                ...
                <div key={name} style={{ display: "flex", gap: 12, marginBottom: 10 }}>
                  ...
                  <div>
                    <span style={{ color: "#F0F4F8", fontSize: 13, fontWeight: 600 }}>{name}: </span>
                    <span style={{ color: "#7A9CC0", fontSize: 13 }}>{tip}</span>
                  </div>
                </div>
              ))}
            </div>
...
// ═══════════════════════════════════════════════════════════════════════════
// UPLOAD SCREEN (M-PESA PDF IMPORT)
// ═══════════════════════════════════════════════════════════════════════════
          ...
          <div>
            <div style={{ ...S.card, marginBottom: 16 }}>
              <div style={{ fontSize: 13, color: "#7A9CC0", lineHeight: 1.6, marginBottom: 20 }}>
                Upload your Safaricom M-PESA statement PDF. If it is password protected, you will be asked for the password from the Safaricom email.
                <br /><br />
              ...
              <label style={{ display: "block", border: "2px dashed #1E3A5F", borderRadius: 12, padding: "32px 20px", textAlign: "center", cursor: "pointer" }}
                ...
                <div style={{ color: "#F0F4F8", fontWeight: 600, marginBottom: 4 }}>
                  {stage === "reading" ? "Reading file..." : "Tap to select PDF"}
                </div>
                <div style={{ color: "#4A6A8A", fontSize: 13 }}>M-PESA statement (.pdf)</div>
              </label>
              {parseError && (
                <div style={{ marginTop: 16, padding: "12px 16px", background: "#3D0000", borderRadius: 10, color: "#E53E3E", fontSize: 13 }}>{parseError}</div>
              )}
            </div>
            ...
            <div style={{ ...S.card, background: "#0A1628", border: "1px solid #1E3A5F" }}>
              ...
              {[["1","Dial *334#","Piga *334#"],["2","Select My Account → Statement","Chagua Akaunti Yangu → Taarifa"],["3","Choose date range (max 6 months)","Chagua kipindi (miezi 6 max)"],["4","Statement sent to your email","Taarifa inatumwa kwa barua pepe"]].map(([n,en,sw]) => (
                <div key={n} style={{ display: "flex", gap: 12, marginBottom: 10 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 13, color: "#F0F4F8" }}>{en}</div>
                    <div style={{ fontSize: 11, color: "#4A6A8A" }}>{sw}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div style={S.card}>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <div style={{ color: "#7A9CC0", fontSize: 13, lineHeight: 1.6 }}>
                ...
                <br /><span style={{ color: "#4A6A8A" }}>Ingiza nenosiri kutoka barua pepe uliyopewa na Safaricom.</span>
              </div>
            </div>
            <div style={{ marginBottom: 8 }}>
              <label style={S.label}>Password / Nenosiri</label>
              <input style={{ ...S.input, fontSize: 18, letterSpacing: "0.1em" }} type="password"
                placeholder="Enter password" value={password} autoFocus
            ...
            <p style={{ color: "#4A6A8A", fontSize: 12, marginBottom: 20, lineHeight: 1.5 }}>
              We never store your password. It is only used to unlock this file.<br />
              Hatuhifadhi nenosiri lako. Inatumika kufungua faili tu.
            </p>
            <div style={{ display: "flex", gap: 12 }}>
              ...
              {parsedTxns.slice(0, 5).map(t => (
                <div key={t.id} style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid #1E3A5F", fontSize: 13 }}>
                  <div>
                    ...
                    <div style={{ color: "#4A6A8A", fontSize: 11 }}>{t.date} · {t.description.slice(0,30)}</div>
                  </div>
                  <div style={{ fontWeight: 600, color: t.amount > 0 ? "#00C875" : "#E53E3E" }}>
                    {t.amount > 0 ? "+" : ""}KES {Math.abs(t.amount).toLocaleString()}
                  </div>
...
export default function InFoachApp() {
  ...
  // Wake up HF space + restore session on mount
  useEffect(() => {
    wakeUpAPI();
    if (_authToken) {
      try {
